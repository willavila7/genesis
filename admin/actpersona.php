...
<div class="wrapper">
  ...
  <div class="content-wrapper">
          ...
          <div class="box box-primary">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="date" name="txtfechnac" value="<?php ActDatosPer($idpersona,'5'); ?>">
                </div>
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label>Celular</label>
                      <input class="form-control" type="text" name="txtcelular" value="<?php ActDatosPer($idpersona,'8'); ?>" data-inputmask="'mask': '999-999-999'" data-mask>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label>E-mail</label>
                      <input class="form-control" type="email" name="txtcorreo1" value="<?php ActDatosPer($idpersona,'10'); ?>" placeholder="@ejemplo.com">
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label>E-mail alterno</label>
                      <input class="form-control" type="email" name="txtcorreo2" value="<?php ActDatosPer($idpersona,'11'); ?>" placeholder="@ejemplo.com">
                    </div>
                  </div>
                </div>
                <div class="row">
    ...
    <div class="box-footer">
      <button class="btn btn-primary pull-right" name="actpersona" type="submit">Actualizar</button>
    </div>
    </form>
