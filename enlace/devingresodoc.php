...
$query1="UPDATE expediente set idestadoexp='6' where idexpediente='$idexpediente' and idarea='$idar';";
$consulta=mysqli_query(conectar(),$query1);
/*
$query2="UPDATE expediente set expediente='0' where idexpediente='$idexpediente' and idarea='$idar';";
$consulta1=mysqli_query(conectar(),$query2);
*/
if($consulta){
