...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
	...
	$query="SELECT * from vta_rptdocdis where idarea='$ar' and idderiva is null and fechingsist>='$ini 00:00:00' and fechingsist<='$fin 23:59:59' order by expediente asc;";
...
$dompdf->render();
$dompdf->stream("Reporte_ingresados.pdf");
?>
