...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        REPORTE DE HISTORICO DE DOCUMENTOS
    ...
    <form action="reportepdfdistot.php" method="post">
    <section class="content-header">
      <p class="margin">
        <div class="row ">
          <div class="col-md-6">
          ...
          <div class="box-body table-responsive no-padding">
            <table id="tabla" class="table table-hover">
              ...
              <tbody>
                ...
                $query="SELECT * FROM vta_rptdocdis where idarea='$ar' order by idexpediente desc;";
