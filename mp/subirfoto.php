...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-md-4">
        <form class="" action="../enlace/regfotoperfilmp.php" method="post" enctype="multipart/form-data">
          <div class="box box-primary">
              <div class="box-body box-profile">
                ...
                <button class="btn btn-primary btn-block" type="submit" name="foto"><b>Subir Foto</b></button>
              </div>
          </div>
        </form>
    </div>
      ...
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="informacion">
            <form class="form-horizontal" action="../enlace/regactperfilmp.php" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" name="txtdireccion" value="<?php UsuarioDatos($dato,'4'); ?>" placeholder="Ingrese...">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="email" class="form-control" name="txtcorreo1" value="<?php UsuarioDatos($dato,'7'); ?>" placeholder="@EMPRESA.COM">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Correo Alternativo</label>
                <div class="col-md-10">
                  <input type="email" class="form-control" name="txtcorreo2" value="<?php UsuarioDatos($dato,'8'); ?>" placeholder="@EJEMPLO.COM">
                </div>
              </div>
              <div class="box-footer">
                <button class="btn btn-primary pull-right" type="submit" name="perfil">Actualizar</button>
              </div>
            </form>
          </div>
        </div>
