...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
	...
	$query="SELECT * from vta_rptdistot where idarea='$ar' and fechingsist>='$ini 00:00:00' and fechingsist<='$fin 23:59:59' order by expediente asc;";
...
$dompdf->render();
$dompdf->stream("Reporte_historico.pdf");
?>
